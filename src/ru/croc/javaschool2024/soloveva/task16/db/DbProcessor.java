package ru.croc.javaschool2024.soloveva.task16.db;
...
public class DbProcessor {
    private static String INSERT_INTO_CLIENTS = "insert into clients (id, surname, name, number) values (?, ?, ?, ?)";
    private static String INSERT_INTO_PETS = "insert into pets (id, name, age) values (?, ?, ?)";
    private static String INSERT_INTO_CLIENTS_PETS = "insert into clients_pets (client_id, pet_id) values (?, ?)";
    ...
    public void createDb() throws SQLException {
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            stat.execute("create table clients(id int generated by default as identity primary key, " +
                    "surname varchar(255), name varchar(255), number varchar(255) unique)");
            stat.execute("create table pets(id int generated by default as identity primary key, " +
